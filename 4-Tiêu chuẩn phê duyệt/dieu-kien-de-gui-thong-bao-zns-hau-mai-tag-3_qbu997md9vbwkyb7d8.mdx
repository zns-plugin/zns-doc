---
id: dieu-kien-de-gui-thong-bao-zns-hau-mai-tag-3_qbu997md9vbwkyb7d8
...
Để gửi mẫu thông báo ZNS cấp độ Hậu mãi, Quý khách sẽ thông qua quy trình như sau: 
-----------------------------------------------------------------------------------
...
**Các cơ chế gửi và nhận ZNS template tag Hậu mãi**
---------------------------------------------------

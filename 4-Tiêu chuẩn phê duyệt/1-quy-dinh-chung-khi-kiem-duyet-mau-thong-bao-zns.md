...
| --- | --- |
| Tag 1 – GIAO DỊCH<br>(TRANSACTION) | Các nội dung cần liên quan **đến từng/các giao dịch cụ thể**<br>VD minh họa: Gửi mã xác thực; Biến động số dư ; Xác nhận đặt hàng/đặt lịch hẹn/đặt chỗ; Thông báo trạng thái giao dịch; Yêu cầu thanh toán cho dịch vụ đã sử dụng; ... |
...
_Nếu có bất kì yêu cầu hỗ trợ, Quý khách có thể liên hệ với đội ngũ hỗ trợ và chăm sóc khách hàng của chúng tôi qua **Biểu Mẫu:**_ [_**Mẫu hỗ trợ Zalo Business Solutions**_](https://go.zalo.me/SupportZBS). Chúng tôi sẽ phản hồi Quý khách trong vòng 24h làm việc tiếp theo._

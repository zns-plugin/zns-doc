...
---
id: cap-nhat-moi-zns-yeu-cau-thanh-toan-payment-request_qbu7mzk8yr8njzzav6
...
1\. Tại [Zalo Cloud Account (ZCA)](https://account.zalo.cloud/) > truy cập [Tạo mẫu ZNS](https://account.zalo.cloud/tool/zns/createTemplate) > Chọn **ZNS yêu cầu thanh toán**

  
![](https://stc-oa.zdn.vn/uploads/89dc23844aab407eb8edb1c0524cdda4.png)

2\. Với **ZNS yêu cầu thanh toán**, quý khách cần sử dụng Logo. Ngoài ra, quý khách có thể tùy chỉnh số lượng Văn bản và Bảng, sử dụng tùy chọn CTA theo nhu cầu.
